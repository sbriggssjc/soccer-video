Set-Location "D:\Projects\soccer-video"
python tools/render_follow_unified.py `
    ...
    --out "out/portrait_reels/2026-02-23__TSC_vs_NEOFC/002__v22_fixes.mp4" `
    --portrait 1080x1920 `
    --preset cinematic `
    --fps 24 `
    --diagnostics `
    --use-ball-telemetry 2>&1 | Tee-Object -FilePath "out/portrait_reels/2026-02-23__TSC_vs_NEOFC/002__v22_fixes.log"
