"""Generate filmstrip review images + blank CSVs for ALL Greenwood clips."""
...
PREFIX = "gw_"
CLIP_NUMS = [f"{i:03d}" for i in range(1, 28)]  # 001-027
...
print("\nDone! Greenwood filmstrips + CSVs on Desktop (prefix: gw_).")
