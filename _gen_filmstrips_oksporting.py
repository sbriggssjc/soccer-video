"""Generate filmstrip review images + blank CSVs for OK Sporting Nov 22 clips 001-004."""
import os, csv, math
import cv2
import numpy as np
from pathlib import Path

GAME = "2025-11-22__TSC_vs_OK_Sporting"
PREFIX = "oks_"
CLIP_NUMS = [f"{i:03d}" for i in range(1, 5)]

os.chdir(r"D:\Projects\soccer-video")
FPS = 30
SAMPLE_INTERVAL = 15
COLS = 4; THUMB_W = 480; THUMB_H = 270; PAD = 4; LABEL_H = 24
...
for clip_num in CLIP_NUMS:
    ...
    for i, frame_idx in enumerate(sample_indices):
        ...
        cv2.putText(canvas, label, (x0+4, y0+LABEL_H-6), cv2.FONT_HERSHEY_SIMPLEX, 0.45, (200,200,200), 1)
...
print("Done! All filmstrips and CSVs on Desktop.")
